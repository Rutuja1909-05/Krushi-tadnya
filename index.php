...
<head>
    ...
    <style>
        ...
        .lightbox-content {
            ...
            background-color: rgba(255, 255, 255, 0.9); /* Adjust opacity for content */
            border-radius: 10px;
            padding: 20px;
            box-shadow: 0px 0px 20px 10px rgba(0,0,0,0.1);
        }
...
.moving-text {
    ...
    padding: 0 20px; /* Adjust padding to ensure background covers the text properly */
    font-weight: bold; /* Increase the boldness of the text */
}
...
<!-- Bot icon -->
    ...
    <a href="#" class="bot-icon">
        <img src="navicons/organic.png" alt="Bot">
    </a>
<nav>
...
<a href="#" class="nav-icon">
    ...
    <a href="#" class="nav-icon">
        <img src="navicons/bar-chart.png" alt="Contact">
        <span class="nav-text">Crop Analysis</span>
    </a>
    <a href="#" class="nav-icon">
        <img src="navicons/map.png" alt="Products">
        <span class="nav-text">Mapping</span>

    <a href="#" class="nav-icon">
        <img src="navicons/chatbot.png" alt="Products">
        <span class="nav-text"> ChatBot</span>
    </a>
    
    <a href="#" class="nav-icon">
        <img src="navicons/add-product.png" alt="Products">
        <span class="nav-text"> Add Products</span>
    </a>

    <a href="#" class="nav-icon">
        <img src="navicons/price-tag.png" alt="Contact">
        <span class="nav-text">Price Rate</span>

    <a href="#" class="nav-icon">
        <img src="navicons/delivery-box.png" alt="Contact">
        <span class="nav-text">Products</span>

    <a href="#" class="nav-icon">
        <img src="navicons/nurser.avif" alt="Contact">
        <span class="nav-text">Nursery</span>
    ...
    <a href="welcome.php" class="nav-icon">
        <img src="profile_farmer.png" alt="About">
        <span class="nav-text">Profile</span>
    </a>
</nav>
<div class="register-prompt">
    <p class="moving-text">To unlock all features, please register!</p>
</div>
...
<div class="container">
    ...
    <div class="features">
        ...
        <div class="feature">
            <img src="features/smart-farm.png" alt="Icon 4">
    ...
    <div class="content">
        <h2>About us</h2>
        <p> Crops Analysis is a web application that helps the 
...
block the fraud user.
        ...
        <h2>Objective</h2>
        <p>The main objective of this system is to help the farmer’s and the 
...
<script>
    ...
    window.onload = function() {
        openLightbox('lightbox/3.jpeg'); // Change the image URL as needed
    };


    function openBot() {
            // Implement your code to open the bot here
            alert("Bot opened!");
        }

        // Function to show the bot icon
        function showBotIcon() {
            var botIcon = document.getElementById("botIcon");
            botIcon.style.display = "block";
        }

        // Timer to show the bot icon every minute
        setInterval(showBotIcon, 60000); // 60000 milliseconds = 1 minute
